...
urlpatterns = [
    ...
    path('editar_pdf_stock/', views.editar_pdf_stock, name='editar_pdf_stock'),
    path('editar_pdf_contabilidad/', views.editar_pdf_contabilidad, name='editar_pdf_contabilidad'),
